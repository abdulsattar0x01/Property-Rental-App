...
function Profile({navigation}) {
  ...
  const [name,setName] = useState("Abdul Sattar")
  const [email,setEmail] = useState("abdulsattar0x01@gmail.com")
  ...
  return (
    ...
    <View style={styles.wrapper}>
      ...
      <Center flex={1.5} >
      <Button size={'lg'} marginY={5}  backgroundColor={'#1E293B'}_text={{color: "white",fontWeight:"600" }} width={'80%'} onPress={IsLogout}>Log Out</Button>
      </Center>
