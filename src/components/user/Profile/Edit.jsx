  ...
  return (
    <NativeBaseProvider>
          <View style={styles.wrapper}>
            <Center flex={0.7} backgroundColor={"#5D3587"}></Center>
            <Center flex={2} flexDirection={"row"} justifyContent="center" alignItems="center">
            
            <Button onPress={pickImage} leftIcon={<Icon as={Fontisto} name="import" size="sm" />} backgroundColor={"#5D3587"}>
            ...
            <Button endIcon={<Icon as={AntDesign} name="camera" size="sm"  />} backgroundColor={"#5D3587"}>
            ...
            <Icon as={<MaterialIcons name={showpass ? "visibility-off" : "visibility"} />} size={5} mr="2" color="muted.400" />
              ...
              <Button size={'lg'} marginY={5}  backgroundColor={'#5D3587'}_text={{color: "white",fontWeight:"600" }} width={'100%'}>Save Changes</Button>
            </Box>
            <Center flex={0.7} backgroundColor={"#5D3587"}></Center>
          </View>
    </NativeBaseProvider>
