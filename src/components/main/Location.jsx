  ...
  return (
    <NativeBaseProvider>
      ...
      <Center flex={0.6}  >
          ...
          <Button size={'lg'} marginY={5}  backgroundColor={'#344D67'}_text={{color: "white",fontWeight:"600" }} onPress={()=>{navigation.navigate('BottomNavigation', {screen: 'Explore'})}} width={'70%'}>Done</Button>
      </ImageBackground>
